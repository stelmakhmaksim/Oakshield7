...
<%@ include file = "template/head_constructors.jsp" %>
    <!-- Начало jsp блока -->
    <div><label for="idPossibleState">ИД процесса: </label><input id="idPossibleState" name="idPossibleState" type="number" style="background-color: whitesmoke; color: black; font-family:Verdana;"/></div>
